...
function Adapter(client) {
  return {
    ...
    async createUser(user) {
      ...
      const sql = `
        INSERT INTO auth_users (name, email, "emailVerified", image, username)
        VALUES ($1, $2, $3, $4, $5)
    ...
    async getUserByUsername(username) {
      const sql = 'select * from auth_users where username = $1';
    ...
    async updateUser(user) {
      ...
      const { id, name, email, emailVerified, image, username } = newUser;
      const updateSql = `
        UPDATE auth_users set
        name = $2, email = $3, "emailVerified" = $4, image = $5, username = $6
        where id = $1
        RETURNING name, id, email, "emailVerified", image, username
      `;
